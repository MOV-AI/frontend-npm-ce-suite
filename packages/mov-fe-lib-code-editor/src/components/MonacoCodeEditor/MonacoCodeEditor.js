import { editor as monacoEditor, KeyMod, KeyCode } from "monaco-editor-core";
...
const MonacoCodeEditor = forwardRef((props, ref) => {
  // Refs
  ...
  React.useEffect(() => {
    ...
    if (onSave)
      editor.current.addAction({
        id: "save",
        label: "Save",
        keybindings: [KeyMod.chord(KeyMod.CtrlCmd | KeyCode.KeyS)],
        precondition: null,
